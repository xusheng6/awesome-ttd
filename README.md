...
| [Intel PinPlay](https://github.com/intel/pinplay-tools) | Free and Open Source | A collection of tools for program record and replay using Intel Software Development Emulator (SDE). Enables deterministic replay of program execution for debugging and analysis. Includes tools for identifying representative simulation regions in single and multi-threaded applications, useful for performance analysis and architectural research. |
